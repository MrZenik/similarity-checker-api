...
def main():
    ...
    parser.add_argument("-T", '--truncate', dest='truncate',
                        ...
                        help="truncate non-copied portions of highlighted "
                             "code")
    parser.add_argument("-p", '--remove-punctuation', dest='punctuation',
                        action='store_true', default=False,
                        help="punctuation in the code will be automatically "
                             "skipped during the check")
    parser.add_argument("-i", '--remove-imports', dest='imports',
                        action='store_true', default=False,
                        help="automatically remove imports from file. "
                             "If file has imports it will be automatically removed "
                             "and will not be used for checking ")
    parser.add_argument("-O", '--out-file', dest='out_file',
                        ...
                        help="path to save output report to. A '.html' "
                             ...
                             "report.html.")
    parser.add_argument("-TID", '--teacher-id', dest='teacher_id', type=int, help="Teacher id who made a request.")
